...
function phone_link_sc($atts, $content = null) {
    ...
    $output = '<a itemprop="telephone" href="tel:'.$phone.'">'.$phone.'</a>';
 ...
 */
add_shortcode('contact-form', 'primary_contact_form_sc');
function primary_contact_form_sc($atts, $content = null) {
