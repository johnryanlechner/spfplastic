...
// Concatenate & Minify Team Modal JS
// function compileTeamModalScript() {
//     return gulp
//         .src(['assets/js/src/team-modal.js'], { sourcemaps: false })
//         .pipe(uglify())
//         .pipe(rename('team-modal.min.js'))
//         .pipe(gulp.dest('assets/js', { sourcemaps: false }));
// }
...
function watch() {
    ...
    //gulp.watch('assets/js/src/team-modal.js', compileTeamModalScript);
    gulp.watch(
        [
            'assets/js/src/*.js',
            '!assets/js/src/custom-footer.js',
